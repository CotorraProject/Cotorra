...
{
    public class IncidenciaHEFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public IncidenciaHEFunction(FunctionParams functionParams)
        {
        ...
        {
            return new IncidenciaHEFunction(_functionParams);
        }
