...
{
    public class HE_ExentasAnteriorFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public HE_ExentasAnteriorFunction(FunctionParams functionParams)
        {
            _functionParams = functionParams;
        }

        public HE_ExentasAnteriorFunction(FunctionParams functionParams, double x, double y)
        {
            _functionParams = functionParams;
            _x = x;
            _y = y;
        ...
        {
            return new HE_ExentasAnteriorFunction(_functionParams, _x, _y);
        }
