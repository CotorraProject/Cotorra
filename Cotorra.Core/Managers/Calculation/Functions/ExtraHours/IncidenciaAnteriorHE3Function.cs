...
{
    public class IncidenciaAnteriorHE3Function : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public IncidenciaAnteriorHE3Function(FunctionParams functionParams)
        {
        ...
        {
            //IncidenciaAnterior[Horas extras 3]
            var result = 0.0;
        ...
        {
            return new IncidenciaAnteriorHE3Function(_functionParams);
        }
