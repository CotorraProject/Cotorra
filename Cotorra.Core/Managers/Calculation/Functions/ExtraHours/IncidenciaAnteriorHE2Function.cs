...
{
    public class IncidenciaAnteriorHE2Function : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public IncidenciaAnteriorHE2Function(FunctionParams functionParams)
        {
        ...
        {
            //IncidenciaAnterior[Horas extras 2]
            var result = 0.0;
        ...
        {
            return new IncidenciaAnteriorHE2Function(_functionParams);
        }
