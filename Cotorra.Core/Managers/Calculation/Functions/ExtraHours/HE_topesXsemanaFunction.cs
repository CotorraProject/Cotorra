...
namespace Cotorra.Core.Managers.Calculation.Functions.ExtraHours
{
    ...
    public class HE_topesXsemanaFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public HE_topesXsemanaFunction(FunctionParams functionParams)
        {
           ...
           double horasTurnoEmpleado)
        {
            ...
            foreach (var diaHorasExentas in horasExentasPorDia)
            {
                ...
                if (diasTranscurridos == DIAS_POR_SEMANA)
                {
                    ...
                    exentoPeriodo += (exentoPorSemana > tope5Umas) ? tope5Umas : exentoPorSemana;
        ...
        {
            return new HE_topesXsemanaFunction(_functionParams);
        }
