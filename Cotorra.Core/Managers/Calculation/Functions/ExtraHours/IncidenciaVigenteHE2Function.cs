...
{
    public class IncidenciaVigenteHE2Function : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public IncidenciaVigenteHE2Function(FunctionParams functionParams)
        {
        ...
        {
            //IncidenciaVigente[Horas extras 2]
            var result = 0.0;
        ...
        {
            return new IncidenciaVigenteHE2Function(_functionParams);
        }
