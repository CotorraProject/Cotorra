...
{
    public class SalariosMinimos_ZonaA : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public SalariosMinimos_ZonaA(FunctionParams functionParams)
        {
            _functionParams = functionParams;
        }

        public SalariosMinimos_ZonaA(FunctionParams functionParams, double x)
        {
            _functionParams = functionParams;
            _x = x;
        }
        ...
        public double calculate()
        {
            ...
            if (minimunSalaries.Any())
            {
                ...
                {
                    result = Convert.ToDouble(minimunSalary.FirstOrDefault().ZoneA);
                }
            }
        ...
        {
            return new SalariosMinimos_ZonaA(_functionParams, _x);
        }
