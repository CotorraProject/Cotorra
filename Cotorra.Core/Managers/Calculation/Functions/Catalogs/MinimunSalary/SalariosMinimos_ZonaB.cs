...
{
    public class SalariosMinimos_ZonaB : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public SalariosMinimos_ZonaB(FunctionParams functionParams)
        {
            _functionParams = functionParams;
        }

        public SalariosMinimos_ZonaB(FunctionParams functionParams, double x)
        {
            _functionParams = functionParams;
            _x = x;
        }
        ...
        public double calculate()
        {
            ...
            if (minimunSalaries.Any())
            {
                ...
                {
                    result = Convert.ToDouble(minimunSalary.FirstOrDefault().ZoneB);
                }
            }
        ...
        {
            return new SalariosMinimos_ZonaB(_functionParams, _x);
        }
