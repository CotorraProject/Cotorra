...
{
    public class PercepcionDespensaTotalFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public PercepcionDespensaTotalFunction(FunctionParams functionParams)
        {
        ...
        {
            return new PercepcionDespensaTotalFunction(_functionParams);
        }
