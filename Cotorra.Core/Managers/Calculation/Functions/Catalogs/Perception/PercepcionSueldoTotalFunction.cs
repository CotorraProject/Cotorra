...
{
    public class PercepcionSueldoTotalFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public PercepcionSueldoTotalFunction(FunctionParams functionParams)
        {
        ...
        {
            return new PercepcionSueldoTotalFunction(_functionParams);
        }
