...
{
    public class DeduccionPrestamoCajadeAhorroPorcentajeFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public DeduccionPrestamoCajadeAhorroPorcentajeFunction(FunctionParams functionParams)
        {
        ...
        {
            //Deducción 58 Préstamo Caja de Ahorro Valor
            var result = 0.0;
        ...
        {
            return new DeduccionPrestamoCajadeAhorroPorcentajeFunction(_functionParams);
        }
