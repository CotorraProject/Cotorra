...
{
    public class DeduccionPtmoInfonavitVsmValorFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public DeduccionPtmoInfonavitVsmValorFunction(FunctionParams functionParams)
        {
        ...
        {
            //Deducción 15 Ptmo Infonavit vsm (Valor)
            var result = 0.0;
        ...
        {
            return new DeduccionPtmoInfonavitVsmValorFunction(_functionParams);
        }
