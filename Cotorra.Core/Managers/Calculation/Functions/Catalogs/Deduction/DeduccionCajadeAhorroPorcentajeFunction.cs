...
{
    public class DeduccionCajadeAhorroPorcentajeFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public DeduccionCajadeAhorroPorcentajeFunction(FunctionParams functionParams)
        {
        ...
        {
            return new DeduccionCajadeAhorroPorcentajeFunction(_functionParams);
        }
