...
{
    public class DeduccionPtmoEmpresa4PorcentajeFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public DeduccionPtmoEmpresa4PorcentajeFunction(FunctionParams functionParams)
        {
        ...
        {
            return new DeduccionPtmoEmpresa4PorcentajeFunction(_functionParams);
        }
