...
{
    public class DeduccionPtmoEmpresa2PorcentajeFunction : FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public DeduccionPtmoEmpresa2PorcentajeFunction(FunctionParams functionParams)
        {
        ...
        {
            return new DeduccionPtmoEmpresa2PorcentajeFunction(_functionParams);
        }
