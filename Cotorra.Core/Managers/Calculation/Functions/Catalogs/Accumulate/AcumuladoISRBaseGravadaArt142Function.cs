...
{
    public class AcumuladoISRBaseGravadaArt142Function : AccumulatedBase, FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public AcumuladoISRBaseGravadaArt142Function(FunctionParams functionParams)
        {
        ...
        {
            return new AcumuladoISRBaseGravadaArt142Function(_functionParams);
        }
