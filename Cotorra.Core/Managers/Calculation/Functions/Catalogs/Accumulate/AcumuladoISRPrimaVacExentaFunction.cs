...
{
    public class AcumuladoISRPrimaVacExentaFunction : AccumulatedBase, FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public AcumuladoISRPrimaVacExentaFunction(FunctionParams functionParams)
        {
        ...
        {
            return new AcumuladoISRPrimaVacExentaFunction(_functionParams);
        }
