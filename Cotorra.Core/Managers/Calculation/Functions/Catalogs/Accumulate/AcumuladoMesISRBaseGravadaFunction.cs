...
{
    public class AcumuladoMesISRBaseGravadaFunction : AccumulatedBase, FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public AcumuladoMesISRBaseGravadaFunction(FunctionParams functionParams)
        {
        ...
        {
            return new AcumuladoMesISRBaseGravadaFunction(_functionParams);
        }
