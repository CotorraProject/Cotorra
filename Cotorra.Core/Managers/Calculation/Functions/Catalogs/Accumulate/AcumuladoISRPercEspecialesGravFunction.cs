...
{
    public class AcumuladoISRPercEspecialesGravFunction : AccumulatedBase, FunctionExtension
    {
        #region "Attributes"
        ...
        #region "Constructor"
        public AcumuladoISRPercEspecialesGravFunction(FunctionParams functionParams)
        {
        ...
        {
            return new AcumuladoISRPercEspecialesGravFunction(_functionParams);
        }
