        ...
        public static string Encrypt(string strText)
        {
            ...
            using (var rsa = new RSACryptoServiceProvider(2048))
            {
                try
                {
                    ...
                    var encryptedData = rsa.Encrypt(encodedText, true);
