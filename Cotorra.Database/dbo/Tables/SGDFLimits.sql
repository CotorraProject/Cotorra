...
CREATE TABLE [dbo].[SGDFLimits] (
    ...
    RiesgodeTrabajo_9	    DECIMAL(18, 6)   NOT NULL, 

    CONSTRAINT [PK_SGDFLimits] PRIMARY KEY CLUSTERED ([ID] ASC)
);
GO

--GetAll 
CREATE NONCLUSTERED INDEX [IX_SGDFLimits_InstanceID]
    ON [dbo].[SGDFLimits]([InstanceID], [Active]);
GO
