...
CREATE TABLE [dbo].[IMSSEmployeeTable] (
    ...
    CONSTRAINT [PK_IMSSEmployeeTable] PRIMARY KEY CLUSTERED ([ID] ASC)
);
GO

--GetAll 
CREATE NONCLUSTERED INDEX [IX_IMSSEmployeeTable_InstanceID]
    ON [dbo].[IMSSEmployeeTable]([InstanceID], [Active]);
GO
