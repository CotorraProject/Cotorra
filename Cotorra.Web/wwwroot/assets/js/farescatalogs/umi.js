    ...
    UI: {
        ...
        LoadGrid: function (data) {
            ...
            let columns = [
                ...
                { field: 'Value', title: 'Valor UMI', template: UX.Cotorra.Common.GridFormatCurrency('Value') },
                {
                    title: ' ', width: 100,
                ...
                function () {
                    ...
                    $('#np_cat_saverecord').formValidation({
                        ...
                        fields: {
                            ...
                            np_Value: {
                                validators: {
                                    notEmpty: { message: 'Debes capturar el valor de la UMI' }
                                }
                            }
                        },
