...
UX.Cotorra.SGDFLimits = {

    UI: {

        CatalogName: 'SGDFLimits',
        ContainerSelector: '#np-farescatalogs',
        TitleModalsString: 'topes SGDF',
        ...
        LoadGrid: function (data = []) {
            ...
            let columns = [
                ...
                { field: 'RiesgodeTrabajo_9', title: 'Riesgo de trabajo', width: 150 },
                {
                    title: ' ', width: 100,
