...
UX.Cotorra.MonthlyEmploymentSubsidy = {

    UI: {

        CatalogName: 'MonthlyEmploymentSubsidy',
        ...
        LoadGrid: function (data = [], setValidity = true) {
            ...
            if (data.length > 0 && setValidity) {
                ...
                $drpValidity.off('change').on('change', function () { UX.Cotorra.MonthlyEmploymentSubsidy.UI.LoadGrid([data[parseInt($(this).val())]], false); });
                $drpValidity.change();
                return;
            ...
            let fields = {
                ...
                MonthlySubsidy: { type: 'string' }
            };

            //Set columns
            let columns = [
                { field: 'LowerLimit', title: 'Límite inferior', template: UX.Cotorra.Common.GridFormatCurrency('LowerLimit') },
                { field: 'MonthlySubsidy', title: 'Subsidio al empleo', template: UX.Cotorra.Common.GridFormatCurrency('MonthlySubsidy') },
                {
                    title: ' ', width: 100,
                ...
                function () {
                    ...
                    var saveModel = new Ractive({
                        ...
                        data: {
                            ...
                            MonthlySubsidy: row ? row.dataItem.MonthlySubsidy : ''
                        }
                    });
                            ...
                            UX.Cotorra.Catalogs.Save(
                                ...
                                (id) => {
                                    ...
                                    if (!row) {
                                        ...
                                        dataItem.MonthlySubsidy = data.MonthlySubsidy;
