...
{
    [Authentication]
    public class IMSSEmployerTableController : Controller
    {
        private readonly Client<IMSSEmployerTable> client;

        public IMSSEmployerTableController()
        {
            SessionModel.Initialize();
            client = new Client<IMSSEmployerTable>(SessionModel.AuthorizationHeader, clientadapter:
