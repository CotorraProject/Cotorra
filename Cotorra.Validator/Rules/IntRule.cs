...
{
    public class IntRule : IValidationRule
    {
        ...
        public IntRule(string fieldName, string friendlyFieldName,  double min, double max, int erorCode)
        {
            this.Max = max;
            this.Min = min; 
        ...
        public Tuple<bool, List<RuleValidation>> ExecuteValidationObject(List<object> ToValidate)
        {
